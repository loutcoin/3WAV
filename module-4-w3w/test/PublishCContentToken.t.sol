...
//import {WavZip} from "../src/3WAVi__ORIGINS/WavZip.sol";
import {
    CreatorTokenStorage
...
contract PublishCContentTokenTest is Test {
    ...
    // Tests that publishCContentToken successfully runs when passed "ideal" inputs
    // (i) I believe we have to add owner as authorized address
    /*function testPublishCContentTokenHappyPath() public {
    ...
    function testWavSaleCContentTokenHappyPath() public {
        ...
        (
            ...
            uint16 _num,
            uint256 _bal
        ) = WavAccess(address(wavDiamond)).returnOwnershipIndex(buyer, 0);
