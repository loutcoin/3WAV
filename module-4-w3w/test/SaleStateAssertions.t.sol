...
contract SaleStateAssertions is Test {
    ...
    // Knock out "all birds with two stones"
    // There are 4 true token distinctions:
    // SContentTokens, CContentTokens + SVariants, CVariants
    // Can just test wavSale && preRelease sale states of:
    // CContentToken and SVariant (SContentToken Variant)
    // This will effectively cover all ground +
    // Increase time efficiency while on crunch
